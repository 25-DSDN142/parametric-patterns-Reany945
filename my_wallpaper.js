let Role = 90; // Size of the character
let lineThickness = 3.0; // Thickness of the lines
        
let mainColorR = 255;   
let mainColorG = 150;
let mainColorB = 180;

let densityFactor = 1.2; // Density of the pattern, 0.7 for medium density
...
let earScaleFactor = 0.8;
let eyeSizeFactor = 1.5;
