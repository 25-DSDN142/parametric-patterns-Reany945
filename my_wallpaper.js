let Role = 110;// Size of the character
let lineThickness = 4;// Thickness of the lines
        
let mainColorR = 150;   
let mainColorG = 180;
let mainColorB = 255;

let densityFactor = 1.8; // Density of the pattern, 1.0 for high density
